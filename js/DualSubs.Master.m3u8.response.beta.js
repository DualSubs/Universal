...
const $ = new Env("🍿️ DualSubs: 🎦 Universal v0.8.9(8) Master.m3u8.response.beta");
const URL = new URLs();
...
function setOption(platform = "", playlist0 = {}, playlist1 = {}, type = "", standard) {
	...
	// 修改语言代码
	newOption.OPTION.LANGUAGE = ((standard) ? LANGUAGE2 : LANGUAGE1).toLowerCase();
	// 增加副语言
	newOption.OPTION["ASSOC-LANGUAGE"] = ((standard) ? LANGUAGE1 : LANGUAGE2).toLowerCase();
	// 修改链接
